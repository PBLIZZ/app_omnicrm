...
describe("Testing Package Demo", () => {
  ...
  describe("Repository Mock Examples", () => {
    it("should mock listContacts with default behavior", async () => {
      ...
      const result = await fakes.contacts.listContacts(userId, params);
    ...
    it("should handle custom mock behaviors", async () => {
      ...
      fakes.contacts.createContact.mockResolvedValue(
        makeOmniClientWithNotes({
  ...
  describe("Error Scenarios", () => {
    it("should handle database errors", async () => {
      ...
      await expect(
        fakes.contacts.listContacts(testUtils.defaultUserId, testUtils.createPaginationParams()),

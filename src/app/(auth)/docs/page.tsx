  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <div className="bg-white p-6 rounded-lg shadow-md">
          ...
          <p className="text-gray-600 mb-4">
            Explore our API endpoints with an interactive Swagger UI interface. Test API calls
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          ...
          <p className="text-gray-600 mb-4">
            Download our OpenAPI specification in JSON format for integration with your API tools
            and code generators.
          </p>
          <Link
      ...
      <div className="bg-white p-6 rounded-lg shadow-md">
        ...
        <p className="text-gray-600">
          For more detailed information, refer to the Swagger documentation or contact our support
          team.
        </p>
      </div>
    </div>

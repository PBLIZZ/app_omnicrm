    ...
    <div className="container mx-auto py-8 px-4 max-w-4xl">
      ...
      <div className="prose prose-lg max-w-none">
        ...
        <section className="mb-8">
          ...
          <p>
            By accessing and using CodexCRM, you accept and agree to be bound by the terms and
        ...
        <section className="mb-8">
          ...
          <p>
            CodexCRM is a customer relationship management platform designed to help businesses
            manage their contacts, tasks, and marketing activities.
          </p>
        </section>

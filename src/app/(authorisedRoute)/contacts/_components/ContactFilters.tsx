...
export function ContactFilters({ filters, onChange, className }: Props): JSX.Element {
  ...
  function toggleSource(source: string, value: boolean): void {
    const next = value
...
function ToggleRow({ label, checked, onCheckedChange }: ToggleRowProps): JSX.Element {
  return (

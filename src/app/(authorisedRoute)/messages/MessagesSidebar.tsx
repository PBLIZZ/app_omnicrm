...
const mockThreads = [
  {
    ...
    lastMessage: "Thanks for the session info...",
    unread: 3,
    timestamp: "2m ago",
    avatar: "SJ",
  },
  ...
  },
  {
    id: "3",
    contact: "Emma Watson",
    lastMessage: "The meditation session was amazing",
    unread: 0,
    timestamp: "3h ago",
    avatar: "EW",
  },
  ...
  },
  {
    id: "5",
    contact: "Lisa Park",
    lastMessage: "Thank you for the yoga tips!",
    unread: 0,
    timestamp: "2d ago",
    avatar: "LP",
  },
...
export function MessagesSidebar(): JSX.Element {
      ...
      <SidebarGroup>
        ...
        <SidebarMenu>
          ...
          <SidebarMenuItem>
            <SidebarMenuButton asChild>
              <Link
                href={{ pathname: "/messages/starred" }}
                className="flex items-center justify-between w-full"
              >
                <div className="flex items-center gap-3">
          ...
          {mockThreads.map((thread) => (
            <SidebarMenuItem key={thread.id}>
              <SidebarMenuButton asChild className="h-auto p-2">
                <Link
                  href={{ pathname: `/messages/thread/${thread.id}` }}

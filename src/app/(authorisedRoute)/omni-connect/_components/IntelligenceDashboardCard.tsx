...
const mockDigests: WeeklyDigest[] = [
  {
    ...
    date: "2025-01-20",
    summary:
      "Strong week with 15% increase in new client inquiries. Notable uptick in yoga class bookings and wellness consultation requests.",
    keyInsights: [
  ...
  },
  {
    ...
    date: "2025-01-13",
    summary:
      "Focused on re-engaging dormant clients. Successful email campaign resulted in 12 session bookings from previously inactive clients.",
    keyInsights: [
  ...
  },
  {
    ...
    date: "2025-01-06",
    summary:
      "New Year brought surge in wellness goal inquiries. 23 new prospects, mostly interested in stress management and flexibility programs.",
    keyInsights: [
...
const mockWikiItems: MarketingWikiItem[] = [
  ...
  },
  {
    ...
    category: "content",
    summary:
      "12 months of wellness-focused campaign themes with email templates and social media content",
  ...
  },
  {
    ...
    category: "automation",
    summary:
      "Proven email sequences for different client lifecycle stages to improve retention rates",
        ...
        <CardContent>
          ...
          <div className="mb-6">
            <div className="flex items-center justify-between mb-3">
              ...
              <Button size="sm" variant="ghost" onClick={onGenerateNewDigest} className="text-xs">
                Generate New
              </Button>
            </div>
          ...
          <div className="flex gap-2">
            <Button variant="default" size="sm" className="flex-1" onClick={onViewAllDigests}>
              <FileText className="h-4 w-4 mr-1" />
              View All Digests
            </Button>
            <Button variant="outline" size="sm" className="flex-1" onClick={onWikiOpen}>

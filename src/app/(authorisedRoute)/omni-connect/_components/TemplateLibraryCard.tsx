...
export function TemplateLibraryCard({ 
  ...
  const getCategoryColor = (category: string) => {
    switch (category) {
      case "client-journey": return "bg-blue-100 text-blue-800";
      case "client-care": return "bg-green-100 text-green-800"; 
  ...
  const getCategoryEmoji = (category: string) => {
    switch (category) {
      case "client-journey": return "🧘";
      case "client-care": return "💪";

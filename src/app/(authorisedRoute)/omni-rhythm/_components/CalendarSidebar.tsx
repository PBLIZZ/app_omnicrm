...
export function CalendarSidebar(): JSX.Element {
  ...
  const toggleSourceVisibility = (): void => {
    // In a real implementation, this would update the calendar source visibility
    // TODO: Implement calendar source visibility toggle
  };
  ...
  return (
    <SidebarContent>
      {/* Calendar Navigation */}
      <SidebarGroup>
        <SidebarGroupLabel>Omni Rhythm</SidebarGroupLabel>
        <SidebarMenu>
          <SidebarMenuItem>
            <SidebarMenuButton asChild isActive={pathname === "/omni-rhythm"}>
              <Link href="/omni-rhythm" className="flex items-center w-full">
                <Calendar className="w-4 h-4 mr-3" />
                <span>Rhythm View</span>
              </Link>
            </SidebarMenuButton>
          </SidebarMenuItem>
          <SidebarMenuItem>
            <SidebarMenuButton asChild>
              <Link href="/omni-rhythm/agenda" className="flex items-center w-full">
                <CalendarDays className="w-4 h-4 mr-3" />
                <span>Rhythm Agenda</span>
              </Link>
            </SidebarMenuButton>
          </SidebarMenuItem>
          <SidebarMenuItem>
            <SidebarMenuButton asChild>
              <Link href="/omni-rhythm/schedule" className="flex items-center w-full">
                <Clock className="w-4 h-4 mr-3" />
                <span>Rhythm Schedule</span>
              </Link>
            </SidebarMenuButton>
          </SidebarMenuItem>
        </SidebarMenu>
      ...
      <SidebarGroup>
        ...
        <SidebarMenu>
          <SidebarMenuItem>
            <SidebarMenuButton asChild>
              <Link href="/omni-rhythm/new" className="flex items-center w-full">
                <Plus className="w-4 h-4 mr-2" />
                <span>New Rhythm Event</span>
              </Link>
            </SidebarMenuButton>
          </SidebarMenuItem>
          <SidebarMenuItem>
            <SidebarMenuButton asChild>
              <Link href="/omni-rhythm/availability" className="flex items-center w-full">
                ...
                <span>Set Rhythm Availability</span>
              </Link>
            </SidebarMenuButton>
          </SidebarMenuItem>
          <SidebarMenuItem>
            <SidebarMenuButton asChild>
              <Link href="/omni-rhythm/booking-links" className="flex items-center w-full">
                <Video className="w-4 h-4 mr-2" />
                <span>Rhythm Booking Links</span>
              </Link>
            </SidebarMenuButton>
          </SidebarMenuItem>
        </SidebarMenu>
      ...
      {/* Today's Events */}
      <SidebarGroup>
        <SidebarGroupLabel>Today&apos;s Rhythm Events</SidebarGroupLabel>
        <SidebarMenu>
            ...
            return (
              <SidebarMenuItem key={event.id}>
                <SidebarMenuButton asChild className="h-auto p-2">
                  <Link href={`/omni-rhythm/event/${event.id}`} className="flex items-start w-full">
      ...
      <SidebarGroup>
        <div className="flex items-center justify-between">
          <SidebarGroupLabel>Rhythm Sources</SidebarGroupLabel>
          <Button
            variant="ghost"
            size="sm"
      ...
      <SidebarGroup>
        ...
        <SidebarMenu>
          <SidebarMenuItem>
            <SidebarMenuButton asChild>
              <Link href="/omni-rhythm/integrations" className="flex items-center w-full">
                <Settings className="w-4 h-4 mr-2" />
                <span>Rhythm Integrations</span>
              </Link>
            </SidebarMenuButton>
          </SidebarMenuItem>
          <SidebarMenuItem>
            <SidebarMenuButton asChild>
              <Link href="/omni-rhythm/notifications" className="flex items-center w-full">

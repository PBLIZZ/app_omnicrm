...
export function GmailSyncButton({
  ...
  variant = "default",
  size = "default",
}: GmailSyncButtonProps): JSX.Element {
  ...
  const handlePreviewSync = async (): Promise<void> => {
    ...
    try {
      ...
      // No need to return previewData since function is void
    } catch (error: unknown) {
      const oauthError: OAuthError = {
  ...
  const handleApproveSync = async (): Promise<void> => {
    setIsLoading(true);
    ...
    try {
      ...
      // No need to return syncData since function is void
    } catch (error: unknown) {
      const oauthError: OAuthError = {
  ...
  const handleRunJobs = async (): Promise<void> => {
    setIsLoading(true);
    ...
    try {
      ...
      // No need to return jobData since function is void
    } catch (error: unknown) {
      const oauthError: OAuthError = {

...
export function TasksListView({ tasks, isLoading }: TasksListViewProps): JSX.Element {
  const [sorting, setSorting] = useState<SortingState>([]);
  const [selectedTasks, setSelectedTasks] = useState<string[]>([]);

  const columns: ColumnDef<Task & { taggedContactsData?: Array<{ id: string; displayName: string; }> }>[] = [
    {
      id: "select",
      header: ({ table }) => (
        <Checkbox

    ...
    <div className="flex-1 space-y-6 p-4 md:p-6">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">--</div>
            <p className="text-xs text-muted-foreground">Tasks and deadlines</p>
          </CardContent>
        </Card>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            This module is currently under development and will include comprehensive task
            management, project tracking, and calendar integration features.
          </CardDescription>
        </CardHeader>

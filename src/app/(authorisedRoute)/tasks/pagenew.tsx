...
import { TasksListView } from "@/app/(authorised)/tasks/components/tasks-list-view";
import { TasksKanbanView } from "@/app/(authorised)/tasks/components/tasks-kanban-view";
import { CreateTaskDialog } from "@/app/(authorised)/tasks/components/create-task-dialog";
import { ApprovalQueue } from "@/app/(authorised)/tasks/components/approval-queue";
          ...
          <CardHeader className="pb-4">
            <div className="flex items-center justify-between">
              <CardTitle className="text-lg">
                {selectedWorkspace !== "all" 
                  ? workspaces.find(w => w.id === selectedWorkspace)?.name || "Tasks"
                  : "All Tasks"
                }
              </CardTitle>

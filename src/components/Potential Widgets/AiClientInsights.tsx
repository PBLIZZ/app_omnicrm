  ...
  const insights = [
    {
      ...
      content:
        "Sarah has missed 2 consecutive appointments. Consider reaching out with a personalized message to re-engage.",
    ...
    },
    {
      ...
      content:
        "Alex has shown significant improvement in anxiety symptoms over the last month based on assessment scores.",
    ...
    },
    {
      ...
      content:
        "Emma is celebrating 1 year as your client next week. Consider sending a milestone celebration note.",
    ...
    },
    {
      ...
      content:
        'Based on recent sessions, Michael might benefit from joining your "Stress Management" group.',
              ...
              <CarouselItem key={insight.id}>
                <Card>
                  ...
                  <CardContent className="pb-4">
                    ...
                    <Button variant="link" className="mt-2 h-8 p-0 text-primary" asChild>

...
// Replaced custom Timeline UI with simple div-based layout to avoid missing module
...
const mockTimelineEvents: TimelineEvent[] = [
  {
    ...
    description:
      "First meeting to discuss goals and establish treatment plan. Client expressed anxiety about upcoming work presentation.",
  ...
  },
  {
    ...
    description:
      "Worked on cognitive behavioral techniques. Client reported improvement in sleep patterns.",
  ...
  },
  {
    ...
    description:
      "Brief check-in call after client reported difficult day. Provided coping strategies.",
  ...
  },
  {
    ...
    description:
      "Participated in weekly anxiety support group. Shared personal progress with group.",
...
export function ContactTimeline({ contactId, limit = 10 }: ContactTimelineProps): JSX.Element {
  ...
  return (
    <Card data-contact-id={contactId}>
              ...
              {events.map((event) => (
                <div key={event.id} className="flex gap-3">
                  <div
                    ...
                    style={{ backgroundColor: event.iconBackground }}
                  >
                    {event.icon}
                  </div>
                      ...
                      <div className="mt-3 space-y-2">
                        ...
                        {event.metadata.aiInsights && (
                          <div className="mt-3 bg-purple-50 p-2 rounded-md border border-purple-100">
                            ...
                            <p className="text-xs text-purple-800">{event.metadata.aiInsights}</p>
                          </div>
                        )}

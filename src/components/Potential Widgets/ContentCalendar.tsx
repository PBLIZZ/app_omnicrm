      ...
      <div className="space-y-6">
        <div className="bg-blue-50 dark:bg-blue-950/20 p-6 rounded-lg">
          ...
          <p className="text-muted-foreground mb-6">
            Plan, schedule, and automate your content across all platforms. Our intuitive rhythm
      ...
      <div className="space-y-6">
        <Card className="border-blue-100 dark:border-blue-900/50 py-0">
          <CardHeader className="pt-6 pb-3 bg-blue-50 dark:bg-blue-950/20 rounded-t-lg">
            <CardTitle className="text-lg font-semibold">Rhythm Preview</CardTitle>
        ...
        <div className="bg-amber-50 dark:bg-amber-950/20 p-4 rounded-lg">
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Need content for your rhythm? Our Lead Magnet Studio helps you create valuable

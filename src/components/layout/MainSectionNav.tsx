...
export function MainSectionNav(): JSX.Element {
      ...
      {mainNavItems.map((item) => {
        ...
        return (
          <Link
            ...
            className={`main-nav-item flex items-center gap-2 text-sm font-medium rounded-md px-3 py-1.5 transition-all duration-200 ${isActive ? "active" : ""}`}
            title={item.title}
          >

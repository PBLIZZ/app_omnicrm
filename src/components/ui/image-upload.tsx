...
export function ImageUpload({ value, onChange, disabled = false }: ImageUploadProps): JSX.Element {
  ...
  const { data: fileUrlData } = useFileUrl(value || "", {
    ...
    async (acceptedFiles: File[]) => {
      ...
      try {
        ...
        const uploadResponse = await fetch(uploadUrlResponse.signedUrl, {
          method: "PUT",
          body: file, // guarded above; File extends Blob which is a valid BodyInit
          headers: {
